...
from binlogUtil import command_line_args, concat_sql_from_binlog_event, create_unique_file, temp_open, \
...
# -B, --flashback 生成回滚SQL，可解析大文件，不受内存限制,-K, --no-primary-key 对INSERT语句去除主键
# -h10.10.11.50 -P12336 -uroot -p'dev@2022' -duc -tcustomer_trade_client --start-file="mysql-bin.000052" --start-datetime="2023-05-01 00:00:00" --stop-datetime="2023-05-20 00:00:00"
if __name__ == '__main__':
    print(sys.argv[1:])
    args = command_line_args(sys.argv[1:])
    #conn_setting = {'host': args.host, 'port': args.port, 'user': args.user, 'passwd': args.password, 'charset': 'utf8'}
    conn_setting = {'host': '10.10.11.50', 'port': 12336, 'user': 'root', 'passwd': 'dev@2022', 'charset': 'utf8'}
